...
public class ArrayUtilsTest extends TestConstants {
    ...
    void emptyStringToIntArray() {
        ...
        int[] result = ArrayUtils.stringToIntArray("q");
    ...
    void randomStringToIntArray() {
        ...
        int[] result = ArrayUtils.stringToIntArray(java.util.Arrays.toString(expected));
        assertArrayEquals(expected, result);
    }
    ...
    public void testGenerateIntArraySimple() {
        ...
        int[] result = ArrayUtils.generateIntArray(maxValue, length);
    ...
    public void testGenerateIntArrayComplex() {
        ...
        int[] result = ArrayUtils.generateIntArray(minValue, inputtedMax, desiredLength, lengthDelta);
